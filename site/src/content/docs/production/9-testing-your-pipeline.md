...
git switch --no-track -c chapter/09-testing-your-pipeline origin/chapter/09-testing-your-pipeline
# Switched to a new branch 'chapter/09-testing-your-pipeline'
```
